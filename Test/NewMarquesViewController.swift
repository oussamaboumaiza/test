//
//  NewMarquesViewController.swift
//  Test
//
...
class NewMarquesViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
        ...
        ref?.child("brands").observeSingleEvent(of:.value) { snapshots in
         ...
         for eachSnap in snapshot {
          ...
          // eachUserDict is an object/ dictionary representation for each user
            ...
            if eachUserDict["isNew"] as? Int == 1 {
